...
(* #### Exercise 2 *)
let%test "palindromes_1" = derive palindromes [1;1;3;2 ] |> to_string = "11011"
let%test "palindromes_2" = derive palindromes [ 0; 1; 2 ] |> to_string = "0110"
let%test "palindromes_3" = derive palindromes [ 0;1;1;1;3;2 ] |> to_string = "011101110"

(* #### Exercise 3 *)
let%test "balanced_parentheses_1" = derive balanced_parentheses [ 0; 4; 2; 7 ] |> to_string = "()[]{}"
let%test "balanced_parentheses_2" = derive balanced_parentheses [ 1; 2; 7; 4; 7 ] |> to_string = "({})[]"
let%test "balanced_parentheses_3" = derive balanced_parentheses [ 1; 3; 4; 5; 2; 0; 7; 7; 7; 7] |> to_string = "({[][{}()]})"
